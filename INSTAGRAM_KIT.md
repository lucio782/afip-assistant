# Kit de Instagram — ARCA Assistant

Todo listo para copiar y pegar. Publica 2-3 veces por semana, siempre con el link en la bio.

## Bio (opciones)

**Opción A (simple):**
```
Calculadora de Monotributo 2026 GRATIS 🇦🇷
Sabé tu categoría, cuánto pagás y cuándo vence
Dólar blue en vivo + control de gastos
Hecho por Lucio → link en bio
```

**Opción B (orientada a negocio):**
```
🚀 Ayudo a monotributistas a no pagar de más
Calculadora de categoría 2026 + vencimientos + dólar
100% gratis, sin planes ni límites
Soy Lucio → link en bio
```

## Post de lanzamiento (caption de carrusel)

**Idea visual:** 4 imágenes — (1) portada con "¿En qué categoría de Monotributo estás?", (2) captura de la calculadora, (3) captura del dólar en vivo, (4) "Gratis para siempre" + link.

**Texto:**
```
¿Sabés en qué categoría de Monotributo estás? Y lo más importante: ¿cuánto vas a pagar y cuándo vence?

Hice una herramienta GRATIS que te lo dice en segundos 👇
...
Sin planes pagos, sin límites, sin pedir tarjeta. Tus datos son privados.

Entrá por el link en bio → [link de tu bio]

Si te sirve, guardalo y compartilo con otro monotributista 🙌
```

**Hashtags:**
```
#monotributo #monotributista #afip #arca #impuestosArgentina #dolarhoy #dolarblue #cuentapropista #freelancer #emprendedoresargentina #finanzaspersonales #calculoMonotributo #economiaargentina
```

## Stories (copiar y pegar)

**Story 1 — Encuesta:**
> ¿Sabés tu categoría de Monotributo? 🧮
> [Sí, la tengo clara] / [Ni idea] / [Estoy en la nada]

**Story 2 — Resultado:**
> Para los que respondieron "ni idea" 👉 hay una calculadora gratis que te la dice en segundos. Link en la bio 🔗 (Mi cuenta: @tucuenta)
...
- **Lunes:** tip de monotributo (ej: qué gastos podés deducir)
- **Miércoles:** captura del dólar blue con comentario corto
- **Viernes:** pregunta/respuesta de un usuario (respondé la pregunta en el post)
